...
jQuery(function($) {
  $(".img-fluid").click(function() {
    ...
    console.log(img_src);
    var appear_image =
      "<div id='appear_image_div' onClick='closeImage()'></div>";
    open_img = appear_image.concat(
      "<img id ='appear_image' src='" + img_src + "' />"
    );
...
$(window).scroll(function() {
  if ($(this).scrollTop() + 300 > posicionbtn1.top) {
    $("#btn1")
      .removeClass("button")
      .addClass("button_scroll");
    //$( "h2" ).css( "background", "red" ).fadeOut( "slow" );
  } else {
    $("#btn1")
      .removeClass("button_scroll")
      .addClass("button");
  }
});
////////////////////////
